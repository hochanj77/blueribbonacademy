...
const heroDefaults = {
  headline: "Free",
  accent: "Consultation",
  subheading: "Not sure where to start? Schedule a free consultation with our academic advisors to create a personalized plan for SAT success.",
};

const ctaDefaults = {
  headline: "Your SAT Success Story Starts Here",
  subheading: "Take the first step today. Schedule your free consultation and let's create a plan together.",
...
export default function Consulting() {
  const { data: pageContent } = usePageContent("free_consultation");
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center animate-fade-in-up">
            <h1 className="text-3xl md:text-5xl font-bold text-secondary mb-4 md:mb-6">
              {hero.headline} <span className="text-accent">{hero.accent}</span>
            </h1>
